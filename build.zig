...
pub fn build(b: *std.Build) void {
    ...
    inline for (.{ d_runs, v_runs, odin_runs, c3_runs, systemverilog_runs, llvm_runs, mlir_runs, tablegen_runs, fortran_runs, pdll_runs, batch_runs, openscad_runs, nickel_runs, hare_runs }) |runs| {
        test_step.dependOn(&runs.backend_test_run.step);
        test_step.dependOn(&runs.preview_test_run.step);
    }
