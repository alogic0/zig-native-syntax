...
input, and deterministic-output contract. There are currently 41 parser-backed
languages, 7 partially parser-backed compositions, 4 tokenizer adapters, 16
dedicated scanners, and 27 configured scanners. This classification describes
...
configured package registry exposes 62 backends as **verified structural**
...
- [x] 35. Assembly — **dedicated scanner** (shared GNU/NASM scanner) — *verified lexical*
- [x] 36. NASM — **dedicated scanner** (shared GNU/NASM scanner) — *verified lexical*
...
- [x] 70. Scheme — **parser** (shared S-expression structural scanner) — *verified structural*
...
- [x] 74. Nim — **parser** (shared tolerant declaration parser with pragma pass) — *verified structural*
...
- [x] 78. C3 — **parser** (shared tolerant C-like declaration parser) — *verified structural*
- [x] 79. SystemVerilog — **parser** (owned tolerant declaration parser) — *verified structural*
- [x] 80. LLVM IR — **dedicated scanner** — *verified lexical*
- [x] 81. OpenSCAD — **parser** (shared tolerant declaration parser) — *verified structural*
- [x] 82. Nickel — **parser** (owned tolerant structural scanner) — *verified structural*
- [x] 83. Hare — **parser** (shared tolerant declaration parser) — *verified structural*
