...
input, and deterministic-output contract. There are currently 30 parser-backed
languages, 7 partially parser-backed compositions, 4 tokenizer adapters, 14
dedicated scanners, and 40 configured scanners. This classification describes
...
configured package registry exposes 44 backends as **verified structural**
