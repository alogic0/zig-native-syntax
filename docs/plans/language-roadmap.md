...
input, and deterministic-output contract. There are currently 23 parser-backed
languages, 6 partially parser-backed compositions, 4 tokenizer adapters, 14
dedicated scanners, and 48 configured scanners. This classification describes
...
configured package registry exposes 36 backends as **verified structural**
