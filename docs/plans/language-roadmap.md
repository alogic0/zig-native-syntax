...
input, and deterministic-output contract. There are currently 15 parser-backed
languages, 4 partially parser-backed compositions, 4 tokenizer adapters, 12
dedicated scanners, and 56 configured scanners. This classification describes
...
configured package registry exposes 26 backends as **verified structural**
