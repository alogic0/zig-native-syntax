...
input, and deterministic-output contract. There are currently 40 parser-backed
languages, 7 partially parser-backed compositions, 4 tokenizer adapters, 16
dedicated scanners, and 28 configured scanners. This classification describes
...
configured package registry exposes 61 backends as **verified structural**
